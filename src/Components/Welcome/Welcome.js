          ...
          <div className="WelcomeMessage">
            <Loader active={isLoading}>
              ...
              <h2 className="WelcomeMessage__subtitle">
                Flashcards are a great tool for learning. This app lets you
                easily create and review decks of flashcards.
              </h2>
              <h2 className="WelcomeMessage__subtitle">
                Flashcards work like this: you write question on one side, and
                answer on the other side. You make at least a few such cards,
                like a deck of cards.
              </h2>
              <h2 className="WelcomeMessage__subtitle">
                Then you flip through them, one by one. Each time, you try to
                answer the question on your own. Then you check it with the
                answer you've written on the other side.
              </h2>

              <h2 className="WelcomeMessage__subtitle">
                If the card was hard, you put it at the start of the deck. If
                medium, in the middle. If easy, at the end of the deck. If
                you've repeated a given card so many times you think you've
                completely gotten it, you put that card away.
              </h2>
              <h2 className="WelcomeMessage__subtitle">
            ...
            <h2 className="WelcomeMessage__subtitle">
              ...
              <h2 className="WelcomeMessage__subtitle">
                ...
                <span className="--bold --italic">text and images</span>, in
                your flashcards.
              </h2>
              <h2 className="WelcomeMessage__subtitle">
                For mobile phone users, you can easily{" "}
                <span className="--bold --italic">
                  take a picture with phone camera and upload it to your
                  flashcard in 1 step!
                </span>
              </h2>
